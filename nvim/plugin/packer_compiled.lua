...
local package_path_str = "/Users/johansteinberg/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?.lua;/Users/johansteinberg/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?/init.lua;/Users/johansteinberg/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?.lua;/Users/johansteinberg/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?/init.lua"
local install_cpath_pattern = "/Users/johansteinberg/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/lua/5.1/?.so"
...
_G.packer_plugins = {
  ["any-jump.vim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/any-jump.vim"
  },
  ["asyncrun.vim"] = {
    commands = { "AsyncRun" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/asyncrun.vim"
  },
  ["bufdelete.nvim"] = {
    commands = { "Bdelete", "Bwipeout" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/bufdelete.nvim"
  },
  ["clever-f.vim"] = {
    keys = { { "n", "f" }, { "n", "F" }, { "n", "t" }, { "n", "T" }, { "v", "f" }, { "v", "F" }, { "v", "t" }, { "v", "T" } },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/clever-f.vim"
  },
  ["diffview.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/diffview.nvim"
  },
  ["editorconfig-vim"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/editorconfig-vim"
  },
  ["emmet-vim"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/emmet-vim"
  },
  ["git-blame.nvim"] = {
    commands = { "GitBlameToggle" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/git-blame.nvim"
  },
  ["gv.vim"] = {
    commands = { "GV" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/gv.vim"
  },
  harpoon = {
    ...
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/harpoon"
  },
  hop = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/hop"
  },
  ["limelight.vim"] = {
    commands = { "Limelight" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/limelight.vim"
  },
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim"
  },
  ["nvim-comment"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/nvim-comment"
  },
  ["nvim-compe"] = {
    after_files = { "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/nvim-compe/after/plugin/compe.vim" },
    config = { "\27LJ\2\n=\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\vconfig\19packages.compe\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/nvim-compe"
  },
  ["nvim-lspconfig"] = {
    config = { "\27LJ\2\nF\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\22lspinstall_config\17packages.lsp\frequire\0" },
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/nvim-lspconfig"
  },
  ["nvim-lspinstall"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/nvim-lspinstall"
  },
  ["nvim-treesitter"] = {
    ...
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/nvim-treesitter"
  },
  ["open-browser.vim"] = {
    config = { "\27LJ\2\nC\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\vconfig\25packages.openbrowser\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/open-browser.vim"
  },
  ["packer.nvim"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/packer.nvim"
  },
  ["pears.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/pears.nvim"
  },
  ["plenary.nvim"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/plenary.nvim"
  },
  ["popup.nvim"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/popup.nvim"
  },
  ["suda.vim"] = {
    commands = { "SudaRead", "SudaWrite" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/suda.vim"
  },
  ["telescope.nvim"] = {
    commands = { "Telescope" },
    ...
    loaded = false,
    needs_bufread = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/telescope.nvim"
  },
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/tokyonight.nvim"
  },
  ["vim-easy-align"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/vim-easy-align"
  },
  ["vim-fugitive"] = {
    commands = { "G", "Git" },
    loaded = false,
    needs_bufread = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/vim-fugitive"
  },
  ["vim-matchup"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/vim-matchup"
  },
  ["vim-repeat"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/vim-repeat"
  },
  ["vim-ripgrep"] = {
    commands = { "Rg" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/vim-ripgrep"
  },
  ["vim-surround"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/vim-surround"
  },
  ["vim-yoink"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/vim-yoink"
  },
  ["visualstar.vim"] = {
    keys = { { "x", "*" }, { "x", "#" } },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/visualstar.vim"
  },
  ["which-key.nvim"] = {
    loaded = true,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/start/which-key.nvim"
  },
  ["zen-mode.nvim"] = {
    commands = { "ZenMode" },
    config = { "\27LJ\2\n¡\1\0\0\5\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\3\0005\4\4\0=\4\5\3=\3\a\2B\0\2\1K\0\1\0\vwindow\1\0\0\foptions\1\0\2\17cursorcolumn\1\15cursorline\1\1\0\3\vheigth\4Í™³æ\fÌ™³ÿ\3\nwidth\3d\rbackdrop\3\1\nsetup\rzen-mode\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/johansteinberg/.local/share/nvim/site/pack/packer/opt/zen-mode.nvim"
  }
}
