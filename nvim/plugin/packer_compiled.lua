...
_G.packer_plugins = {
  ...
  ["zen-mode.nvim"] = {
    commands = { "ZenMode" },
    config = { "\27LJ\2\n¡\1\0\0\5\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\3\0005\4\4\0=\4\5\3=\3\a\2B\0\2\1K\0\1\0\vwindow\1\0\0\foptions\1\0\2\17cursorcolumn\1\15cursorline\1\1\0\3\nwidth\3d\rbackdrop\3\1\vheigth\4Í™³æ\fÌ™³ÿ\3\nsetup\rzen-mode\frequire\0" },
    loaded = false,
    needs_bufread = false,
...
if vim.fn.exists(":AnyJump") ~= 2 then
...
if vim.fn.exists(":AnyJumpBack") ~= 2 then
...
if vim.fn.exists(":AnyJumpLastResults") ~= 2 then
...
if vim.fn.exists(":AnyJumpVisual") ~= 2 then
