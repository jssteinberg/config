...
vim.api.nvim_set_hl(0, "@property.vim", { link = "FG" })
...
vim.api.nvim_set_hl(0, "@tag.attribute.svelte", { link = "Constant" })
vim.api.nvim_set_hl(0, "@tag.delimiter", { link = "Constant" })
vim.api.nvim_set_hl(0, "@tag.delimiter.svelte", { link = "Constant" })
