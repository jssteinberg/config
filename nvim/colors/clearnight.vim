...
hi Title cterm=NONE gui=NONE ctermfg=255 guifg=#e9f5e6
...
hi Statement  cterm=NONE gui=NONE ctermbg=NONE guibg=NONE ctermfg=255 guifg=#e9f5e6
...
hi CursorLineNr cterm=italic gui=italic ctermbg=0 guibg=#1a1636 ctermfg=255 guifg=#e9f5e6
...
hi WildMenu cterm=underline,bold gui=bold ctermbg=0 guibg=#342c6d ctermfg=255 guifg=#e9f5e6
...
hi DiffAdd    cterm=bold gui=bold ctermbg=NONE guibg=NONE ctermfg=255 guifg=#e9f5e6
...
hi StatusLine   cterm=NONE gui=NONE ctermbg=0 guibg=#1a1636 ctermfg=255 guifg=#e9f5e6
