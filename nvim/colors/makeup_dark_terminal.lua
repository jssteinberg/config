...
-- Linked
hi("javascriptTSTag", { link = "Tag" })
hi("markdown_inlineTSURI", { link = "markdownUrl" })
hi("Tag", { link = "Type" })
hi("TSPunctBrack", { link = "Delimiter" })
hi("TSTag", { link = "Tag" })
hi("TSProperty", { link = "Type" })

-- UI

hi("ColorColumn", { bg = color("black", 2) })
hi("Conceal", { bg = color("black", 2) })
hi("Cursor", { bg = color("white") })
hi("CursorColumn", { bg = color("black"), bold = true })
hi("CursorLine", { bg = color("black") })
hi("CursorLineNr", { bg = color("black"), fg = color("magenta", 2) })
hi("Directory", { fg = color("magenta"), bold = true })
hi("LineNr", { fg = color("gray") })
hi("MatchParen", { bg = color("black", 2), fg = color("magenta", 2), italic = true })
hi("MatchParenCur", { bg = color("black", 2) })
hi("MatchWord", { bg = color("black", 2), italic = true })
hi("NonText", { fg = color("black", 2) })
hi("NvimInternalError", { bg = color("error"), fg = color("error") })
hi("Pmenu", { bg = color("black", "bg"), fg = color("gray") })
hi("PmenuThumb", { bg = color("black", 2) })
hi("SignColumn", { fg = color("cyan", 2) })
